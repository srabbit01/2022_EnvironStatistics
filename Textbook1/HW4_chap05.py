...
approach.
(b) If 
  0.05, what is the power of the test in part (a) for a
...
plastic is important. It is known that 12  1.0 psi. From a
random sample of size n1  10 and n2  12, we obtain
and The company will not adopt plastic
...
standard deviation of burning rate; that is, 1  2  3 cm/s.
Two random samples of n1  20 and n2  20 specimens are
tested; the sample mean burning rates are
and
(a) Test the hypothesis that both propellants have the same
mean burning rate. Use a fixed-level test with 
  0.05.
(b) What is the P-value of the test in part (a)?
(c) What is the -error of the test in part (a) if the true difference
in mean burning rate is 2.5 cm/s?
(d) Construct a 95% CI on the difference in means 1  2.
...
(b) If 
  0.05 and the -error of the test when the true difference
in fill volume is 0.2 fluid ounces should not
exceed 0.1, what sample sizes must be used? Use 
0.05.
'''
...
variance of road octane number for formulation 1 is 2
1  1.5,
and for formulation 2 it is 2
2  1.2. Two random samples of
size n1  15 and n2  20 are tested, and the mean road octane
numbers observed are and Assume
normality.
...
(c) If the hypotheses had been versus
would you reject the null hypothesis at
the 0.05 level?
(d) If the hypotheses had been versus
would you reject the null hypothesis at
